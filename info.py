...
S_GROUP = environ.get('S_GROUP',"https://t.me/planet_movies_grp")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/series_planet_luffy_updates")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'series_planet')
